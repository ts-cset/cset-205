...
class App
{
   ...
   public function __construct($db) {
     ...
     $app->post('/people', function (Request $request, Response $response) {
         ...
         // build query string
         $createString = "INSERT INTO people ";
         ...
         $person = $this->db->query('SELECT * from people ORDER BY id desc LIMIT 1')->fetch();
